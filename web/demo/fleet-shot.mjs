...
await page.goto('http://localhost:8090/demo/fleet-index.html', { waitUntil: 'networkidle' });
...
await page.screenshot({ path: 'demo/fleet-list.png' });
...
await page.screenshot({ path: 'demo/fleet-detail.png' });
