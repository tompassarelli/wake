...
const archiveName = "tompassarelli-wake-runtime-0.1.2.tgz";
const receiptName = "tompassarelli-wake-runtime-0.1.2.receipt.json";
...
function releaseSource(scratch) {
  ...
  run(["git", "commit", "-q", "-m", "Wake 0.1.2 runtime"], { cwd: seed, env: environment });
...
describe("@tompassarelli/wake-runtime package", () => {
  ...
  test("refuses untagged, lightweight-tagged, dirty, wrong-origin, and mismatched releases", () => {
    ...
    try {
      const source = releaseSource(scratch);
      run(["git", "tag", "-d", "v0.1.2"], { cwd: source.first });
      expect(fails([
        packer, "--source-root", source.first, "--version", "v0.1.2",
        "--output", `${scratch}/untagged`,
      ]).exitCode).not.toBe(0);

      run(["git", "tag", "v0.1.2"], { cwd: source.first });
      expect(fails([
        packer, "--source-root", source.first, "--version", "v0.1.2",
